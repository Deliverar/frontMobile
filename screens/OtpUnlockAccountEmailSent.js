...
export default function OtpUnlockAccountEmailSent() {
    ...
    const handleOTP = () => {
        ...
        // alert(mail)
        navigation.navigate('OTPUnlockAccountVerify', data);
    };
            ...
            <View style={styles.content}>
                ...
                <View style={styles.textContainer}>
                    <Text style={styles.text}>
                        Enviaremos un correo a tu casilla, favor de ingresar al link para continuar con el proceso para desbloquear tu cuenta.
                    </Text>
                </View>
