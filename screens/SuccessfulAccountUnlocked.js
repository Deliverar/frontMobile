...
export default function SuccessfulAccountUnlocked() {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.content}>
                ...
                <Text style={styles.text}>Cuenta desbloqueada con éxito!</Text>
                <Button label="Volver al Login" theme="loginButton" onPress={handleComenzarPress} />
            </View>
